                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            MarkQuestAsCompleted(newLocation.QuestAvailableHere);
                        }
                    }
                }
        ...
        public void UseWeapon(Weapon weapon)
        {
            ...
            if(_currentMonster.CurrentHitPoints <= 0)
            {
                ...
                foreach(InventoryItem inventoryItem in lootedItems)
                {
                    ...
                    {
                        RaiseMessage("You found " + inventoryItem.Quantity + " " + inventoryItem.Details.Name);
                    }
                    else
                    {
                        RaiseMessage("You found " + inventoryItem.Quantity + " " + inventoryItem.Details.NamePlural);
                    }
                }
